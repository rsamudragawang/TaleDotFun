<template>
  <Form v-slot="$form" :resolver="resolverChapter" :initialValues="initialValuesChapter" @submit="onFormSubmitChapter">
      ...
      <div class="flex-1 bg-black/40 rounded-lg p-6">
        <div class="flex flex-col gap-4">
          <div class="flex flex-col gap-1">
            ...
            <Message v-if="$form.squareThumbnail?.invalid" severity="error" size="small" variant="simple">
        ...
        <div class="bg-black/40 rounded-lg p-6">
          <div class="flex flex-col gap-6">
            ...
            <div class="flex flex-col gap-1">
              ...
              <InputText name="chapterTitle" type="text" placeholder="Enter your chapter title" class="w-full" />
              <Message v-if="$form.chapterTitle?.invalid" severity="error" size="small" variant="simple">
            ...
            <div class="flex flex-col gap-1">
              ...
              <Message v-if="$form.chapterImages?.invalid" severity="error" size="small" variant="simple">
            ...
            <div class="flex flex-col gap-1">
              ...
              <Textarea name="creatorNotes" placeholder="Add any notes or comments about this chapter"
                class="w-full h-[150px]" />
              <Message v-if="$form.creatorNotes?.invalid" severity="error" size="small" variant="simple">
                ...
                <div class="flex-1">
                  <div class="flex flex-col gap-4">
                    <div class="flex items-center gap-2">
                      <RadioButton v-model="publishOption" name="publishOption" value="now" />
                      <label class="text-white">Publish Now</label>
                    </div>
                    <div class="flex items-center gap-2">
                      <RadioButton v-model="publishOption" name="publishOption" value="schedule" />
                      <label class="text-white">Schedule for Later</label>
                    </div>
                    <div v-if="publishOption === 'schedule'" class="flex flex-col gap-2">
                      <DatePicker name="publishDate" v-model="publishDate" :showTime="true" :showSeconds="false"
                        :minDate="new Date()" placeholder="Select Schedule Date" />
                      <Message v-if="$form.publishDate?.invalid" severity="error" size="small" variant="simple">
